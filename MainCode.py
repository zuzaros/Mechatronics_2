...
high_ground = [(1,1), (1,3), (1,4), (3,1), (3,2), (3,3)] #for example
...
#path = [[(0, 0), (0, 4)], [(0, 4), (0, 2), (2, 2), (2, 1)], [(2, 1), (2, 0), (4, 0), (4, 3)], [(4, 3), (4, 0), (0, 0)]]
...
#now we just need to add the loop for reading the executing channel
#and how to read the worm trigger
#and the manual vs automatic mode
#and how to select the center of the spice area (for now assume it is an input from zuza)